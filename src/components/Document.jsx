  ...
  const getEmbedCode = (case_type) => {
    switch (case_type) {
      ...
      case caseTypes.STUDY_VISA:
        ...
        break;
      case caseTypes.STUDY_WORK_PERMIT_EXTENSION:
        embedCode = `https://creatorapp.zohopublic.in/torontoimmigrationcompany/visa-management/report-embed/All_Study_Work_Permit_Extensions/qWfOsseKVe3bVdWq8p0J6j5RjGhszzAvAMpBkAkG34sfhbxRN7geesJpCC6vXmAGjYkY8bxtHhAVzA7U8muCNmhPzDbW5udMBz9s?Lead.ID=${lead.ID}&hideColumns=Lead.ID;&zc_AddRec=false&zc_Search=false&zc_Header=false&zc_Footer=false&zc_ReportName=false&zc_ShowAs=false`;
        break;
      case caseTypes.STUDY_SPOUSE:
        ...
        break;
      case caseTypes.USA:
        embedCode = `https://creatorapp.zohopublic.in/torontoimmigrationcompany/visa-management/report-embed/All_Usa/njC7tm6yDusqm7DG07741jnU38AuPqqpvwRmjWKxzyf9QadzA4ZYKqhBCSk5J6wgb7JRbK8u2rACEh3pbOvdJ6WfqKOeJsJPQgX8?Lead.ID=${lead.ID}&hideColumns=Lead.ID;&zc_AddRec=false&zc_Search=false&zc_Header=false&zc_Footer=false&zc_ReportName=false&zc_ShowAs=false`;
        break;
      case caseTypes.VISITOR_TO_STUDY:
        ...
        break;
      case caseTypes.VISITOR_VISA:
        embedCode = `https://creatorapp.zohopublic.in/torontoimmigrationcompany/visa-management/report-embed/All_Visitor_Visa/EhdWqfV2EXPCPhOrE4nNgaJWE3sD1HtV5OfBVXrYugDZp3B5h0Onz9ESz7V0nQS4B8MS9NKSa2nADBRXV9rGvrpJEYH1qOVYCD1J?Lead.ID=${lead.ID}&hideColumns=Lead.ID;&zc_AddRec=false&zc_Search=false&zc_Header=false&zc_Footer=false&zc_ReportName=false&zc_ShowAs=false`;
        break;
      case caseTypes.WORK_PERMIT_EXTENSION:
