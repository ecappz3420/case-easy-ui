        ...
        <div className='p-2'>
            <div className="flex justify-between mt-3">
                ...
                <Dropdown label='Send Communications' color='blue' >
                    ...
                    <DropdownItem onClick={()=>setOpenEmail(true)}><i className="bi bi-envelope mr-2"></i>Email</DropdownItem>
                    <DropdownItem><i className="bi bi-phone mr-2"></i>SMS</DropdownItem>
                </Dropdown>
                <Drawer open={openEmail} position='right' className='w-[70vw] overflow-hidden' onClose={()=>setOpenEmail(false)}>
                        <Drawer.Header/>
                        <Drawer.Items>
                            <Email/>
                        </Drawer.Items>
